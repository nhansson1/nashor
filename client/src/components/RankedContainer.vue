...
const gamesPlayedString = `${props.rankEntry.wins}W - ${props.rankEntry.losses
...
<template>
    <Container class="rank-container">
        ...
        <div class="rank-container__details">
            ...
            <p class="rank-container__summary">{{ props.rankEntry.wins + props.rankEntry.losses > 0 ? gamesPlayedString
                : "" }}</p>
        </div>
    </Container>
</template>
